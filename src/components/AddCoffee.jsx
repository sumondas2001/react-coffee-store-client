...
const AddCoffee = () => {
     ...
     const handelAddCoffee = event => {
          ...
          fetch('https://react-coffee-store-server.vercel.app/coffee', {
               method: 'POST',
               headers: {
     ...
     return (
          <div>
               ...
               <div className="max-w-7xl  mx-auto flex text-center  mt-10 px-20 bg-slate-800 py-10 mb-20 rounded-lg" >
                    ...
                    <div>
                         <i className="text-3xl font-extrabold  text-[#D2B48C]">Add New Coffee</i>
                         ...
                         <form onSubmit={handelAddCoffee} className="mt-10">
                              <div className="flex mb-8  ">
                                   <div className="form-control md:w-1/2">
                                        <label className="label">
                                             <span className="label-text">Name</span>
                                        </label>
                                        <input type="text" placeholder="Enter coffee name" name="name" className="input input-bordered mr-6" required />
                                   </div>
                                   <div className="form-control md:w-1/2">
                                        <label className="label">
                              ...
                              <div className="flex mb-8  ">
                                   <div className="form-control md:w-1/2">
                                        ...
                                        <input type="text" placeholder="Enter coffee supplier" name="supplier" className="input input-bordered mr-6" required />
                                   </div>
                                   <div className="form-control md:w-1/2">
                                        <label className="label">
                              ...
                              <div className="flex mb-8 ">
                                   <div className="form-control md:w-1/2">
                                        ...
                                        <input type="text" placeholder="Enter coffee Category" name="category" className="input input-bordered mr-6" required />
                                   </div>
                                   <div className="form-control md:w-1/2">
                                        <label className="label">
                              ...
                              <div className=" flex mb-8 ">
                                   <div className="form-control w-1/2">
                                        ...
                                        <input type="text" name="photo" placeholder="Enter photo URL" className="input input-bordered mr-6" required />
                                   </div>
                                   <div className="form-control w-1/2">
                                        <label className="label">
                                             <span className="label-text">Price</span>
                                        </label>
                                        <input type="text" name="price" placeholder="Enter Coffee Price" className="input input-bordered mr-6" required />
                                   </div>


                              </div>
                              <input className="w-full text-black text-base hover:text-white font-bold btn bg-[#D2B48C] mb-10" type="submit" value="Add Coffee" />
                         </form>
                    </div>
               </div>
          </div>
